...
public class ParamsSelector extends JFrame implements Runnable, ActionListener, KeyListener {
	...
	public ParamsSelector(boolean show, boolean b) {
		...
		textField_6 = new JTextField("Place cube in intake");
		textField_6.setBounds(348, 244, 114, 18);
		...
		while(b){
			...
			try{
				...
				txtSaturation.setText(
						"Saturation: " + Main.visionParams.minSaturation + "-" + Main.visionParams.maxSaturation);
				...
				txtDtci.setText(
						"Distance To Center Importance: " + (Main.visionParams.distToCentreImportance * 100) + "%");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == btnDistance) {
			...
			if (textField_6.getText().equals("Place cube in intake")) {

				Main.visionParams.slope = 1;

				frame = Main.forceProcess();
				
				textField_6.setText("Place cube 1m away");

			} else {
				
				Main.visionParams.slope = 1;

				VisionData frame2 = Main.forceProcess();
				...
				*/
				...
				Main.visionParams.slope = slope;
				Main.visionParams.yIntercept = yIntercept;
				
				
				textField_6.setText("Place cube in intake");
